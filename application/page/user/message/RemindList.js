...
class RemindList extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        const {userremind,navigation} = nextProps;
        if (userremind !== this.props.userremind){
            this.items = msgItems.concat(userremind.items);
            ...
            this.totalPage = userremind.pages;
    ...
    _onHeaderRefresh(){
        ...
        actions.message.userremind(this.page);
    ...
    _renderItem(item){
        ...
        return (
            ...
            >
                <View style={[styles.head,styles.pr_10]}>
                    <View style={styles.msgImgbox}>
                        <Image source={asset.sysIcon} style={styles.headCover} />
                        {
                            msg.status == 0 ?
                    ...
                    <View style={[styles.fd_r]}>
                        <Text style={msg.status === 0 ? [styles.lg_label,styles.black_label,styles.fw_label,styles.lh20_label] : [styles.default_label,styles.tip_label,styles.lh20_label] }>{msg.title}</Text>
                    </View>
                </View>
...
export const LayoutComponent = RemindList;
