...
import {dateDiff,formatTimeStampToTime} from '../../util/common';

const nowTime = (new Date()).getTime();

class OfflineAct extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        if (o2oDetail !== this.props.o2oDetail) {
            ...
            if(o2oDetail.hasFlag){
                // 报名开始时间 大于 当前时间 
                if(o2oDetail.beginTime * 1000  >  nowTime){
                    this.setState({
                        type:0
                    })
                } else if(o2oDetail.beginTime * 1000 < nowTime &&  o2oDetail.endTime * 1000 > nowTime){
                ...
                } else if(o2oDetail.endTime * 1000 < nowTime){
                    this.setState({
                        type:3
                    })
                }
    ...
    _singUp = () => {
        ...
        navigation.navigate('OfflineSignup');
    }
            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={[styles.cons,styles.bg_white,styles.pl_15,styles.pr_15]}>
                        <HtmlView html={this.o2o.content} onLinkPress={this.onLinkPress} />
                    </View>
                </ScrollView>
...
export const LayoutComponent = OfflineAct;
