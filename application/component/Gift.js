                ...
                <View style={[styles.gift_box, styles.bg_white,styles.pt_15]}>
                    ...
                    <View style={[styles.fd_r, styles.ai_ct, styles.jc_sb, styles.pt_5, styles.pb_5, styles.pl_30, styles.pr_20,styles.border_top]}>
                        ...
                        </View>
                        {
                            ...
                            <TouchableOpacity style={[styles.bg_orange, styles.rewardBtn, !reward_enable && styles.disabledContainer]} disabled={!reward_enable} onPress={() => {
                                this._onGiftToggle();
                            ...
                            :
                            <TouchableOpacity style={[styles.bg_orange, styles.rewardBtn]} onPress={() => {
                                onBuy && onBuy(gift_id);
                            }}>
                                <Text style={[styles.white_label ,styles.sm_label]}>购买</Text>
                            </TouchableOpacity>
                        }
